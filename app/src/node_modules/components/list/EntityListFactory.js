...
var EntityListFactory = React.createClass({
  ...
  getActionColumns : function () {
    ...
    // SMART columns
    var col_s = {type : 'icon', hiddenXS : true, title : 'S', attr : 'isspecific', class : this.getSMARTiconClass}
    var col_m = {type : 'icon', hiddenXS : true, title : 'M', attr : 'ismeasurable', class : this.getSMARTiconClass}
    var col_a = {type : 'icon', hiddenXS : true, title : 'A', attr : 'isassignable', class : this.getSMARTiconClass}
    var col_r = {type : 'icon', hiddenXS : true, title : 'R', attr : 'isresultoriented', class : this.getSMARTiconClass}
    var col_t = {type : 'icon', hiddenXS : true, title : 'T', attr : 'istimebound', class : this.getSMARTiconClass}                
...
//    }
  ...
  getRecommendationColumns : function () {
    ...
    return [
            ...
            {type:'icon', title: 'Response', 
             attr:'response', class: function(response){
