...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var tweet = "The #NPA web-tool from @NZHumanRights  "
    var title = "Human Rights Commission: National Plan of Action"
    ...
    var RightNav = (this.isIntro()) ? 
     ...
     : [
      ...
      <Nav className="nav-group nav-group-pages" right>
        <NavItem href='#' className={'nav-item-about'} onClick={this.handleNavClick('about')}>
          About
        </NavItem>
        <NavItem href='#' className={'nav-item-articles'} onClick={this.handleNavClick('articles')}>
          Human Rights Articles
        </NavItem>
        <NavItem href='#' className={'nav-item-terms'} onClick={this.handleNavClick('terms')}>
          Terms
        </NavItem>
      </Nav>      
     ]
