...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
        <header className={headerClass}>
          ...
          >
            {this.renderBrand()}
            {this.renderNavbar(facebookShare,twitterShare)}                        
          </Navbar>
          <ShareModal
  ...
  renderNavbar : function(facebookShare,twitterShare){
    return (<CollapsibleNav eventKey={0} expanded={false}>
  ...
  renderShareNavGroup : function(facebookShare,twitterShare) {
    ...
    return (
      <Nav ulClassName={"nav-group nav-group-share"} navbar>
        <NavItem title="Share on Facebook" eventKey={1} href={facebookShare} className="share-header-social share-header-social-facebook"  target="_blank">
          <div className="icon-social-facebook-sm"/>
        </NavItem>
        <NavItem title="Share on Twitter" eventKey={2} href={twitterShare} className="share-header-social share-header-social-twitter"  target="_blank">
    ...
    return (
      <Nav ulClassName={"nav-group nav-group-pages"} navbar>
        ...
        <NavItem 
            ...
            onClick={this.handleNavClick('terms')}>
          FAQ
        </NavItem>
      </Nav> 
    )    
