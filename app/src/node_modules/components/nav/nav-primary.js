...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var flux = this.getFlux();
    var navItems = [
      {slug:'issues',route:'explore-by',hiddenxs:'Explore by ', title:'Category'},
      {slug:'actions',route:'all',hiddenxs:'All ', title:'Actions'},
      {slug:'recommendations',route:'all',hiddenxs:'All ', title:'Recommendations'},
      {route:'search',hiddenxs:'Search', title:'', icon:'icon-magnifier'}
    ]
                ...
                return (
                  <li>
                    <a
                      ...
                      title={navItem.hiddenxs + ' ' + navItem.title}
                      className={'btn' + (this.isActive(navItem) ? ' active' : '')}
                      href='#'
                      onClick={this.handleItemClick(navItem)}
                    >
                      <span className='hidden-xs'>{navItem.hiddenxs}</span>
                      {navItem.title}
