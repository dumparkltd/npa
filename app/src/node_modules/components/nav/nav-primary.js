...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var flux = this.getFlux();
    var navItems = [
      {slug:'issues',route:'explore-by',title:'<span>Explore by </span>Category'},
      {slug:'actions',route:'all',title:'<span>All </span>Actions'},
      {slug:'recommendations',route:'all',title:'<span>All </span>Recommendations'},
      {route:'search',title:'<span>Search</span> <i class="icon-magnifier">&nbsp;</i>'}
    ]
