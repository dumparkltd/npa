...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var navItems = [
      ...
      {slug:'actions',route:'all',title:'All Actions', titlexs:'Actions'},
      {slug:'recommendations',route:'all',title:'All Recommendations', titlexs:'Recommendations'},
      {route:'search',title:'Search', titlexs:'', icon:'hrc-icons_search'}
    ]
