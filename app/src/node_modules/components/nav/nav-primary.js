...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var navItems = [
      ...
      {slug:'actions',route:'all',title:'All Government Actions', titlexs:'Actions'},
      {slug:'recommendations',route:'all',title:'All UPR Recommendations', titlexs:'Recommendations'},
