  ...
  render: function () {
    ...
    if (this.state.loading[this.props.type]) {
      ...
      if (!this.state.showFilters){
        return (
          <Grid className='hrc-filter-panel'>
            <a href='#' className='hrc-filter-toggle pull-right' onClick={this.toggleFilters()}>Show filter options</a>
          </Grid>
        )
      } else {
        ...
        return (
          <Grid className='hrc-filter-panel-wrapper' fluid={true}>
            <a href='#' className='hrc-filter-toggle pull-right' onClick={this.toggleFilters()}>Hide filter options</a>
            <Grid className='hrc-filter-panel'>
