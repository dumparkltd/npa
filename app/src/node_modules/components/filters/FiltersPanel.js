        ...
        return (
          <div className='hrc-filter-panel-wrapper'>
            ...
            <Grid className='hrc-filter-panel hrc-filter-active'>
                  ...
                  <Row>
                    {
                      _.map(this.props.filtergroups, function(group, i){
                        ...
                        return (
                          <Col className={'hrc-filter-group hrc-filter-group-'+ group.group} sm={group.span} key={i}>
                            <Row>
              ...
              <Row className="hrc-filter-toggle-bottom">
                <Col xs={4} xsOffset={4}>
                  <a href='#' className='hrc-filter-toggle btn' onClick={this.toggleFilters()}>Hide filters</a>
                </Col>
              </Row>
            </Grid>
          </div>
        ...
        component = (
          <span className='filter-component-multiselect'>
            ...
            <Multiselect
              ...
              valueField='id'
              textField='title'
              value={typeof query[filter.by] === 'string' ? [query[filter.by]] : query[filter.by]}
              data={options}
              filter='contains'
              placeholder = {filter.placeholder}
