      ...
      if (!this.state.showFilters){
        return (
          <Grid className='hrc-filter-panel-wrapper hrc-filter-inactive' fluid={true}>
            <a href='#' className='hrc-filter-toggle' onClick={this.toggleFilters()}>
              Show filter options
              <Icon name='filter-open' label='Open filter options'/>
            </a>
          </Grid>
        )
      } else {
        ...
        return (
          <div className='hrc-filter-panel-wrapper'>
            <a href='#' className='hrc-filter-toggle' onClick={this.toggleFilters()}>
              Hide filter options
              <Icon name='filter-close' label='Close filter options'/>
            </a>
        ...
        component = (
          <span className='filter-component-icon'>
            <a href='#' onClick={this.handleIconClick(filter.by, nextOption.value)}>
              <Icon name={filter.icons[currentIndex]} classes={currentOption.value === 'true' ? 'active' : ''}/>
              <div className={"filter-component-icon-text " + currentOption.value + " " + filter.label.replace(' ', '-' )}>{filter.label + currentOption.suffix }</div>
            </a>
          </span>
        )
