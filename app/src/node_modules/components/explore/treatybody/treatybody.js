   ...
   render: function () {
    ...
    || this.state.articlesLoading 
      ...
      <div className="page-content-treaty-body page-content">
        ...
        <Grid className='page-section treaty-body-section-recommendations section-recs'>   
    ...
    return (
      [
        <Row  key={0} className="header-row">
          <Col sm={12}>
            <h5 className="header-type">UN Treaty Body</h5>
      ...
      return ([
        ...
        <EntityTable
          ...
          cols = {[
            ...
            {type:'text', title: 'Te reo Māori',  attr:'titlemaori'}         
          ]}
          entities = {articles} />         
      ])
    } else {
