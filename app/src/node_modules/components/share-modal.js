...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var ariaLive = this.props.shouldHide ? 'off' : 'assertive'
        ...
        <Grid>
          <Row className="share-modal-row">
            ...
            <Col sm={5}>
              ...
              <h5>Copy link</h5>
              <div className="share-modal-control">
                <input onClick={this.handleUrlInputClick} title="Copy link to share current view" className="share-modal-link" type='text' value={this.props.currentHREF} readOnly>{}</input>
              </div>
            </Col>
            <div className="share-modal-close">
 <nav className="hrc-nav-carousel">
        <ul className="hrc-nav-carousel-list list-inline" role="presentation">
          <li className="hrc-nav-carousel-li-back" role="presentation">
            <a href="#" className={'btn'}  onClick={this.handleCloseClick()}  title="Close">
