...
module.exports = React.createClass({
  ...
  renderIssues : function (entity){
    ...
    var issues =  flux.store('issues').filter(function(item){
  ...
  renderGroups : function (entity){
    ...
    var groups =  flux.store('groups').filter(function(item){
  ...
  renderTreatybodies : function (entity){
    ...
    var treatybodies =  flux.store('treatybodies').filter(function(item){
    ...
    return ([
      ...
      <ul>
        {
          _.map(treatybodies,function(item){
            return (
              <li>
                {item.title}
              </li>
