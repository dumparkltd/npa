...
//          {by:'rejected',type:'response',attr:'response',filtergroup:'response',filterlabel:'Not Accepted'}
      ...
      return (
        <div role='main' >
          ...
          <div role='article' className="page-content page-content-all">
            ...
            <Grid className='page-section page-section'>
               <a href='#' onClick={this.exportPdf(conditions)}>Export To Pdf</a>
            </Grid>
  ...
  exportPdf: function (conditions) {
    var flux = this.getFlux()
    return function (e) {
      e.preventDefault()
      flux.actions.export(null, 'all', conditions)
    }
  }
