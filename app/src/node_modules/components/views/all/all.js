...
module.exports = React.createClass({
  ...
  getInitialState : function(){
    return {          
      filtergroups : {
        actions : [
          { group : 'cat', title : '', type:'multiselect', span:12,
            filters : [
          ...
          { group : 'smart', title : 'SMART criteria', type:'icon', options:[
              {prefix:'', value:''},
              {prefix:'', value:'true'},
              {prefix:'Not ', value:'false'}
            ], 
            span:6,
            filters : [
              {by:'specific',type:'smart',attr:'isspecific',label:'Specific', 
                icons:['icon-smart-sm-s','icon-smart-sm-s active','icon-smart-sm-s inactive']},
              {by:'measurable',type:'smart',attr:'ismeasurable',label:'Measurable', 
                icons:['icon-smart-sm-m','icon-smart-sm-m active','icon-smart-sm-m inactive']},
              {by:'assignable',type:'smart',attr:'isassignable',label:'Assignable', 
                icons:['icon-smart-sm-a','icon-smart-sm-a active','icon-smart-sm-a inactive']},
              {by:'resultoriented',type:'smart',attr:'isresultoriented',label:'Result-oriented', 
                icons:['icon-smart-sm-r','icon-smart-sm-r active','icon-smart-sm-r inactive']},
              {by:'timebound',type:'smart',attr:'istimebound',label:'Time-bound', 
                icons:['icon-smart-sm-t','icon-smart-sm-t active','icon-smart-sm-t inactive']}
            ]
          },
          { group : 'date', title : 'Target date', type:'dateselect', span:6,
            filters: [
          ...
          { group : 'response', title : 'Government response', type:'icon', options:[
            ...
            filters: [       
              {by:'accepted',type:'response',attr:'response',label:'Accepted', 
                icons:['icon-accepted' , 'icon-accepted active']},
              {by:'rejected',type:'response',attr:'response',label:'Not Accepted', 
                icons:['icon-rejected', 'icon-rejected active']}             
            ]              
          },
