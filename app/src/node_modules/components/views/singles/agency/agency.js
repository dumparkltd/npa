...
module.exports = React.createClass({
  mixins: [
    ...
    StoreWatchMixin('agencies', 'actions')
  ],
  ...
  render: function () {
    return (
      <div className="hrc-category-view hrc-category-view-agency" 
    ...
    return (
      <Grid role="article" className='page-section agency-section-analysis'>
        <HeaderRow
          supTitle = {'Agency'}
          title = {entity.title}
          tools = {[{type:'download',label:'Download Category Report',handler:this.exportPdf(entity.id)}]}                  
        />
