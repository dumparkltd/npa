...
module.exports = React.createClass({
  ...
  render: function () {
    return (
      <div className="hrc-single-view hrc-single-view-action" aria-live="polite">
        {this.renderContent()}
      </div>
    )
  },
        ...
        <Row key={1}  className="content-main">
          <Col sm={8} className="col-content-main column-smart">
            ...
            <div className="marked-inner-html strong"
             ...
             <a href='#' onClick={this.exportPdf(entity)}>Export To Pdf</a>
          </Col>
  ...
  renderSMART : function(entity) {
    ...
    var criteria = [
      {id:'s',label:'Specific',active:false},
      {id:'m',label:'Measurable',active:false},
      {id:'a',label:'Assignable',active:false},
      {id:'r',label:'Result-oriented',active:false},
      {id:'t',label:'Time-bound',active:false}
    ]
    ...
    return ([
      ...
      <a  key={1} href="#" title="About SMART criteria" onClick={this.handleNavClick('smart')} className='smart-information'>
        <span role="img" aria-label="About SMART criteria" className="icon-information"/>
      </a>,
...
//    var ariaLabel = criterion.label + (criterion.active ? ": satified" : ": not satisfied")
    var ariaLabel = criterion.label + ": not assessed"
    return ([
        <li role="img" aria-label={ariaLabel} className={className_li} style={{width:'20%'}}>
  ...
  exportPdf: function (entity) {
    var flux = this.getFlux()
    return function (e) {
      e.preventDefault()
      flux.actions.exportAction(entity)
    }
  }
})
