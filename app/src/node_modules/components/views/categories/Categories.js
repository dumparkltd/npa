...
var NavCategories = require('components/nav/NavCategories')
...
module.exports = React.createClass({
  ...
  renderMain : function (types,sortBy){
    ...
    var entities = _.sortByOrder(this.getEntities(category,types),[sortBy,'title'],[false,true])
  ...
  getColumns : function(title, types, maxValue){
    ...
    if(types.indexOf('actions') > -1) {
      cols.push({
          ...
          value :     {attr:'countActions',color:'#69A41E'},
          maxValue :  maxValue,
        })
    }
    ...
    if (types.indexOf('recommendations') > -1) {
      cols.push({
          ...
          values :    [
            {attr:'countRecsAccepted',color:'#029BE5',title:'Accepted'},
            {attr:'countRecsNotAccepted',color:'#026B9F',title:'Not accepted'}
          ],
          key : {
            type:'units',
            items: [{
