    ...
    return (
      <div role='main' className='intro text-center'>
            ...
            <Row className="intro-explore-text">
              <Col sm={10} smPush={1} md={6} mdPush={3}>
                <p>
                  ...
                  categorised along four dimensions to provide further 
        ...
        <section className="intro-explore-all">  
          <Grid>
            <h3 className="intro-explore">All actions and recommendations</h3>
            <Row className="intro-explore-text">
              <Col sm={10} smPush={1} md={6} mdPush={3}>
            ...
            <Row className="intro-explore-buttons">
              <Col xs={6} >
                <a href="#" className="btn pull-right" onClick={this.handleItemClick({slug:'actions',route:'all'})}>
                  <span className="btn-inner">All Actions</span>
                </a>
              </Col>
              <Col xs={6} >
                <a href="#" className="btn pull-left" onClick={this.handleItemClick({slug:'recommendations',route:'all'})}>
                  <span className="btn-inner">All Recommendations</span>
                </a>
              </Col>
            </Row>
          </Grid>
