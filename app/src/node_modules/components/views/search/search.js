  ...
  getInitialState : function(){
    return {
      ...
      types : [
        ...
        { type : 'issues', matchId:false },
        { type : 'groups', matchId:false },
        { type : 'agencies', matchId:false },
        { type : 'treatybodies', matchId:false },
        { type : 'pages', excludes:['intro'], matchId:false,
          nestedTypes : [
            { type : 'articles', matchId:false },
            { type : 'faq', matchId:false },
          ]
        }
      ]
    }
