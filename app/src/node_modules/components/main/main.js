...
var NavMode      = require('components/nav/nav-mode')
...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
      <div className={'hrc-app route-' + flux.stores.routes.getCurrentRoute()} aria-live="polite">
        <GoogleAnalytics id="UA-51960056-3" />
        <Header
