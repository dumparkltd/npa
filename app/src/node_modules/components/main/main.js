...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var navItems = [
      {slug:'issues',route:'issue',title:'Issue'},
      {slug:'groups',route:'group',title:'Population Group'},
      {slug:'agencies',route:'agency',title:'Government Agency'},
      {slug:'treatybodies',route:'treatybody',title:'UN Treaty Body'}
    ]
