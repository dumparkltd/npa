...
//      this.dispatch(c.ROUTE.TRANSITION, { route: type, params: { id: id } });
  ...
  multiselect : function (field,values) {
    this.dispatch(c.ROUTE.UPDATE_QUERY,{field:field,values:values})
  },
  date : function (field,date_str) {
    this.dispatch(c.ROUTE.UPDATE_QUERY,{field:field,values:date_str})
  },
  query : function (field,value) {
    this.dispatch(c.ROUTE.UPDATE_QUERY,{field:field,values:value})
  },
  export: function (id, type, conditions) {
    this.dispatch(c.PRINT, {id: id, type: type, conditions: conditions})
  }
};
