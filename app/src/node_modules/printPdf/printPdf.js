...
//          break
  ...
  var loadImages = {
    icon_arrow_dark: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_arrow-dark.png', onSuccess, onError, 'icon_arrow_dark'),
    icon_assignable_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_assignable-yes-large.png', onSuccess, onError, 'icon_assignable_yes'),
    icon_assignable_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_assignable-no-large.png', onSuccess, onError, 'icon_assignable_no'),
    icon_logo_grey: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_logo-grey.png', onSuccess, onError, 'icon_logo_grey', docDefinition),
    icon_logo_white: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_logo-white.png', onSuccess, onError, 'icon_logo_white', docDefinition),
    icon_measurable_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_measurable-yes-large.png', onSuccess, onError, 'icon_measurable_yes'),
    icon_measurable_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_measurable-no-large.png', onSuccess, onError, 'icon_measurable_no'),
    icon_rec_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_rec-no-large.png', onSuccess, onError, 'icon_rec_no'),
    icon_rec_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_rec-yes-large.png', onSuccess, onError, 'icon_rec_yes'),
    icon_result_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_result-yes-large.png', onSuccess, onError, 'icon_result_yes'),
    icon_result_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_result-no-large.png', onSuccess, onError, 'icon_result_no'),
    icon_smart_key_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_smart-key-yes.png', onSuccess, onError, 'icon_smart_key_yes'),
    icon_smart_key_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_smart-key-no.png', onSuccess, onError, 'icon_smart_key_no'),
    icon_specific_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_specific-yes-large.png', onSuccess, onError, 'icon_specific_yes'),
    icon_specific_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_specific-no-large.png', onSuccess, onError, 'icon_specific_no'),
    icon_time_yes: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_time-yes-large.png', onSuccess, onError, 'icon_time_yes'),
    icon_time_no: getImageDataUrl('img/pdf-icons/NPA-pdf-icons_time-no-large.png', onSuccess, onError, 'icon_time_no')
  }
