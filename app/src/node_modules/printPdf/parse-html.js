/*
 based on
 https://github.com/ymkins/html2pdfmake
 */
...
module.exports = function (html) {
    ...
    function ParseElement(cnt, e, p, styles) {
        ...
        switch (e.nodeName.toLowerCase()) {
            ...
            case 'h6':
                ...
                break;
            case 'ul':
                 var ul = {ul: [],margin:[0,0,0,3]};
                 ParseContainer(ul.ul, e, p, styles);
                 cnt.push(ul);
                 break;
             case 'ol':
                 var ul = {ol: [],margin:[0,0,0,3]};
    ...
    function ParseHtml(cnt, htmlText) {
        ...
        el.innerHTML = htmlText.replace(/[\t\n]+/g, '')
        html = el.childNodes
        var p = CreateParagraph();
        for (var i = 0; i < html.length; i++) {
            ParseElement(cnt, html[i], p);
        }
    }

    function CreateParagraph() {
        var p = {text: [],margin:[0,0,0,10]};
        return p;
    }
    function CreateLiParagraph() {
        var p = {text: [],margin:[0,0,0,7]};
        return p;
    }
