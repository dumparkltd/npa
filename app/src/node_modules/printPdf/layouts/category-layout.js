      ...
      if (showRecs) {
        return {
          table : {
            widths: [170],
            body : [
              [ { text: 'Related UPR Recommendation' + (recs.length !== 1 ? 's' : ''), style : ['sideTableCellTitle','sideTableCell','sideTableCellCategory'] }],
              ...
              [ { text : makeCategoryList(recs,', '), style : ['sideTableCell', 'blue','sideTableCellCategory' ] }]
            ]
          },
          layout: 'noBorders',
          style : 'sideTable',
