      ...
      columns : [
        {
          stack : [
            ...
            {text: 'Mahere Rautāki a Motu', style: ['titleHeaderSubtitle']},
          ],
      ...
      columns: [
        {
          stack: [
            ...
            {text: data.reportTitle, style: ['title','titleReportTitle']}
          ],
          width: 514
        },        
        {
          canvas: [{type: 'line', x1: 0, y1: 0, x2:0, y2: 290, lineWidth: 0, lineColor: '#029BE5'}],
          width : 1
        }        
      ]
    },
    {canvas: [{type: 'line', x1: 0, y1: 0, x2:190, y2: 0, lineWidth: 0.5, lineColor: '#ffffff'}], margin: [0, 0, 0, 10]},
    {
      columns: [
        {
          stack: [
            {text: 'IN THIS REPORT:', style: ['title', 'titleInReport'], margin: [0, 0, 0, 20]},
            {
        ...
        {
          canvas: [{type: 'line', x1: 0, y1: 0, x2:0, y2: 170, lineWidth: 0, lineColor: '#029BE5'}],
          width : 1
        } 
      ]
    },
      ...
      columns: [
        {
          stack: [
            ...
            {text: [{text: 'ISBN: ', style: ['bold']}, {text: data.ISBN}], margin: [0, 0, 0, 20]},
            {canvas: [{type: 'line', x1: 0, y1: 0, x2:200, y2: 0, lineWidth: 0.5, lineColor: '#ffffff'}], margin: [0, 0, 0, 15]},
