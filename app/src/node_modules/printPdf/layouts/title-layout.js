...
module.exports = function (data, type, sections) {
  ...
  return [
    ...
    {canvas: [{type: 'line', x1: 0, y1: 0, x2: 205, y2: 0, lineWidth: 0.5, lineColor: '#ffffff'}], margin: [0,0,0,100]},
    {
      columns: [ 
        {
          stack: [
    ...
    {canvas: [{type: 'line', x1: 0, y1: 0, x2:205, y2: 0, lineWidth: 0.5, lineColor: '#ffffff'}], margin: [0, 0, 0, 10]},
    {
      columns: [
        {
          stack: [
    ...
    },
    {
      columns: [
        {
          stack: [
            {canvas: [{type: 'line', x1: 0, y1: 0, x2:205, y2: 0, lineWidth: 0.5, lineColor: '#ffffff'}], margin: [0, 0, 0, 15]},
