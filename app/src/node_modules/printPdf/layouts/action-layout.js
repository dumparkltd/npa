        ...
        table : {
          ...
          body : [
            ...
            [ {canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 0.5, lineColor :'#fff' }],
                colSpan:2,style:'sideTableCellLineSecondary'},''],
            [ 
              {
                text :'Specific',
                style : ['sideTableCellTitleSecondary']   
              },
              {
                image: smart.isspecific ? 'smart-s-pass-active-bg' : 'smart-s-fail-active-bg', 
                rowSpan : 2,width: 25,style : ['sideTableCellTitleSecondary']   
              }
            ],
            [ 
              {
      ...
      return{
        table : {
          ...
          body : [
            ...
            [ { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 0.5, lineColor :'#fff' }],
                style:'sideTableCellLine'}],
            [ { text : categories.issues.length === 1 ? 'Issue' : 'Issues', style : ['sideTableCellTitleSecondary'] }],
            [ { text : makeCategoryList(categories.issues), style : ['sideTableCell', 'blue' ] } ],
            [ { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 0.5, lineColor :'#fff' }],
                style:'sideTableCellLineSecondary'}],            
            [ { text : categories.groups.length === 1 ? 'Population Group' : 'Population Group', style : ['sideTableCellTitleSecondary'] }],
            [ { text : makeCategoryList(categories.groups), style : ['sideTableCell', 'blue' ] }],
            [ { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 0.5, lineColor :'#fff' }],
                style:'sideTableCellLineSecondary'}],            
            [ { text : categories.agencies.length === 1 ? 'Government Agency' : 'Government Agencies', style : ['sideTableCellTitleSecondary'] }],
            [ { text : makeCategoryList(categories.agencies), style : ['sideTableCell', 'blue' ] } ]
          ]
        },
        layout: 'noBorders',
        style : 'sideTable',
      ...
      return {
        table : {
          ...
          body : [
            ...
            [ {canvas: [{ type: 'line', x1: 0, y1: 0, x2: 150, y2: 0, lineWidth: 0.5, lineColor :'#fff' }],style:'sideTableCell'}],
            [ { text : 'No.', style : ['sideTableCellTitleSecondary'] } ],
