...
var EntityStore = Fluxxor.createStore({
  initialize: function(options) {
    ...
    this.searchFields = { 
      ...
      issues:['id','title','currentcontext','otherissuesraised'],
      groups:['id','title','commentary','description'],
      agencies:['id','title','description'],
      treatybodies:['id','title','about','concludingobservations'],
  ...
  loadDataSuccess: function (data) {
    ...
    this.data = _.sortBy(sanitise(data[this.name].elements),function(d){
      d.type = this.type
      return (isInteger(d.id) ? parseInt(d.id) : d.title)
    },this)      
