...
var RouteStore = Fluxxor.createStore({
  ...
  updateQuery : function(payload) {
    ...
    if (payload.values === '') {
      ...
      if (payload.field === 'rejected' && payload.values === 'true') {
        delete updatedQuery['accepted']
      } else if (payload.field === 'accepted' && payload.values === 'true') {
        delete updatedQuery['rejected']
      }
      if (payload.field === 'addressed' && payload.values === 'true') {
        delete updatedQuery['notaddressed']
      } else if (payload.field === 'notaddressed' && payload.values === 'true') {
        delete updatedQuery['addressed']
      }
