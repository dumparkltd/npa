...
var PrintStore = Fluxxor.createStore({
        ...
        switch (payload.type) {
         // single action report
          case 'action' :  
            ...
            report.sections = [
              {short:'A', title : 'Section A', content : ['Government Action '+ payload.id]},
            ...
            report.titleData = {
              reportType : 'Action\nReport',
              supTitle : 'Government Action',
              reportTitle : report.data.actionData.title,              
              date :moment().format('DD/MM/YYYY'),
              ISBN : 'XXX-X-PLEASE-ADVISE'
            }
            report.footer = {
              title : 'Action Report: ' + report.data.actionData.title 
            }
            break
          ...
          case 'issue' : case 'group' : case 'agency' : 
            ...
            report.sections = [
              {title : 'Section A', short: 'A', content : ['This category']},
          ...
          case 'all' :
            ...
            report.sections = [
              {short:'A', title : 'Section A', content : 
                [
                  report.data.categoriesDataList.issues.length + 'Issues',
                  report.data.categoriesDataList.groups.length + 'Population Groups',
                  report.data.categoriesDataList.agencies.length + 'Government Agencies'
                ]
              },
            ...
            report.footer = {
              title : 'Full Report: National Plan of Action 2015 - 2019' 
            }
  ...
  prepareTitleData : function (type,id){
    switch (type) {
      case 'action' :
