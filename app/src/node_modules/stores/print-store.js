...
var PrintStore = Fluxxor.createStore({
        ...
        footer: function(currentPage, pageCount, footerMode) {
          switch (footerMode) {
            case 'action':
              ...
              return {
                stack: [
                {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 600, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
                {columns: [
                  {text: reportTitle,
                  alignment: 'left',
                  style: ['size7', 'grey']},
  ...
  getAction: function (action) {
    ...
    var actionContent = {
      content: [
        {text: 'Action #' + action.id, style: ['size18', 'bold'], margin: [0, 20]},
        {text: action.title, style: ['size18'], margin: [0, 20]},
        {
          columns: [
            {
              stack: [
                {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 300, y2: 5, lineWidth: 0.7 }]},
                (!_.isEmpty(action.description)) ? {text: 'DESCRIPTION', style: ['blue'], margin: [0, 10]} : {text: ''},
                parseHTML(marked(action.description)),
                !_.isEmpty(action.desiredoutcome) ? {text: 'DESIRED OUTCOME', style: ['blue'], margin: [0, 10]} : {text: ''},
                parseHTML(marked(action.desiredoutcome)),
                !_.isEmpty(action.measures) ? {text: 'MEASURES', style: ['blue'], margin: [0, 10]} : {text: ''},
                parseHTML(marked(action.measures)),
                {text: 'TARGET DATE', style: ['blue'], margin: [0, 10]},
            ...
            [
              ...
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {columns: [
                {width: '60%', text: [{text: 'Specific | ' }, {text: action.isspecific ? 'MET' : 'Not met', style: ['size7_5', action.isspecific ? 'green' : 'grey']}]},
                {image: action.isspecific ? 'icon_specific_yes' : 'icon_specific_no', width: 30}
              ]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {columns: [
                {width: '60%', text: [{text: 'Measurable | ' }, {text: action.ismeasurable ? 'MET' : 'Not met', style: ['size7_5', action.ismeasurable ? 'green' : 'grey']}]},
                {image: action.ismeasurable ? 'icon_measurable_yes' : 'icon_measurable_no', width: 30}
              ]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {columns: [
                {width: '60%', text: [{text: 'Assignable | ' }, {text: action.isassignable ? 'MET' : 'Not met', style: ['size7_5', action.isassignable ? 'green' : 'grey']}]},
                {image: action.isassignable ? 'icon_assignable_yes' : 'icon_assignable_no', width: 30}
              ]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {columns: [
                {width: '60%', text: [{text: 'Result-oriented | ' }, {text: action.isresultsoriented ? 'MET' : 'Not met', style: ['size7_5', action.isresultsoriented ? 'green' : 'grey']}]},
                {image: action.isresultsoriented ? 'icon_result_yes' : 'icon_result_no', width: 30}
              ]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {columns: [
                {width: '60%', text: [{text: 'Time-bound | ' }, {text: action.istimebound ? 'MET' : 'Not met', style: ['size7_5', action.istimebound ? 'green' : 'grey']}]},
                {image: action.istimebound ? 'icon_time_yes' : 'icon_time_no', width: 30}
              ]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineWidth: 0.7 }]},
              {text: [{text: 'ACTION ', style: 'bold'}, {text: 'categories'}]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {text: issuesTitle, margin: [0, 10]},
              {text: this.makeCategoryList(issues) , style: 'blue'},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {text: groupsTitle, margin: [0, 10]},
              {text: this.makeCategoryList(groups) , style: 'blue'},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 180, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              {text: agenciesTitle, margin: [0, 10]},
  ...
  getRecommendations: function (recs) {
    var content = {
      stack: [
        {text: 'INDEX: ALL UPR RECOMMENDATIONS', style: ['size10', 'grey', 'bold']},
        {
        ...
        {columns: [
          {width: '10%', text: 'NO.', style: ['size6', 'grey', 'bold']},
          {width: '70%', text: 'UPR RECOMMENDATIONS', style: ['size6', 'grey', 'bold']},
          {width: '10%', text: 'ADDRESSED', style: ['size6', 'grey', 'bold']},
          {width: '10%', text: 'RESPONSE', style: ['size6', 'grey', 'bold']},
        ]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineWidth: 0.7 }]},
        {columns: [
          {width: '80%', text: '', style: ['size5_2']},
          {width: '10%', text: 'Addressed', style: ['size5_2']},
          {width: '8%', text: 'Accepted', style: ['size5_2']},
          {image: 'icon_rec_yes', width: 5}
        ]},
        {columns: [
          {width: '80%', text: '', style: ['size5_2']},
          {width: '10%', text: 'Not Addressed', style: ['size5_2']},
          {width: '8%', text: 'Not Accepted', style: ['size5_2']},
          {image: 'icon_rec_no', width: 7}
        ]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
    ...
    var recsIndex = _.map(recs, function (value, key) {
      var tableOfContents = {
        stack: [
          {columns: [
            {width: '10%', text: value.id, style: ['size10', 'bold']},
            {width: '70%', text: value.title, style: ['size7_5']},
          ...
          //  {image: this.getRelatedActionsLength(value) > 0 ? 'icon_rec_yes' : 'icon_rec_no', width: 20},
            {image: value.response == 'accepted' ? 'icon_rec_yes' : 'icon_rec_no', width: 20},
          ]},
          {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]}
        ],
        footerMode: 'appendix'
  ...
  getCategory: function (payload, category, type) {
    ...
    var categoryContent = {
      content: [
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.8, y2: 5, lineWidth: 0.7, lineColor: '#ffffff' }]},
        {text: "New Zealand's National Plan of Action", style: ["white", "size12", "bold"]},
        {text: "For the Protection and Promotion of Human Rights", style: ["white", "size12"]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.8, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
        {text: type.toUpperCase() + ' REPORT', style: ["white", "size10", "bold"]},
        {text: category.title, style: ['size34', 'white'], margin: [0, 20]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
        {text: 'IN THIS REPORT:', style: ["white", "size10", "bold"]},
        {text: 'Section A', style: ["white", "bold"]},
        {text: category.title, style: ["white"]},
        {text: 'Section B', style: ["white", "bold"]},
        {text: relatedEntities.length + ' Government Actions', style: "white"},
        {text: 'Section C', style: ["white", "bold"]},
        {text: recs.length + ' UPR Recommendations', style: "white"},
        {columns: [
          {stack: [
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
            {text: [{text:'DATE ', style: ["white", "bold"]}, {text: moment().format('DD/MM/YYYY'), style: "white"}]},
            {text: [{text:'ISBN', style: ["white", "bold"]}, {text: 'XXXXX', style: "white"}]},
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
            {text: 'npa.hrc.co.nz', style: ['size21', "white", 'bold']}
          ], width: '50%'},
          {stack: [
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
            {image: 'icon_logo_white', width: 150}
          ], width: '50%'}
        ],
  ...
  getCategoryContent: function (category, type, relatedEntities, allActions) {
    ...
    var relatedEntitiesIndex = _.map(relatedEntities, function (value, key) {
      var tableOfContents = {
        stack: [
          {columns: [
            {width: '5%', text: value.id, style: 'size10'},
            {width: '60%', text: value.title, style: 'size7_5'},
            {image: value.isspecific ? 'icon_specific_yes' : 'icon_specific_no', width: 20, style: 'size7_5'},
            {image: value.ismeasurable ? 'icon_measurable_yes' : 'icon_measurable_no', width: 20,style: 'size7_5'},
            {image: value.isassignable ? 'icon_assignable_yes' : 'icon_assignable_no', width: 20,style: 'size7_5'},
            {image: value.isresultoriented ? 'icon_result_yes' : 'icon_result_no', width: 20,style: 'size7_5'},
            {image: value.istimebound ? 'icon_time_yes' : 'icon_time_no', width: 20,style: 'size7_5'},
            {width: '5%', text: 'B', style: 'grey', style: 'size7_5'},
            {width: '5%', text: _.findWhere(indexOfActions, {id: value.id}).pageNum.toString(), style: 'size7_5'}
          ]},
          {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]}
        ]
      }
    ...
    var categoryContent = [
      {text: type.toUpperCase(), style: ['size10', 'grey', 'bold']},
      {text: category.title, style: ['size26', 'bold'], margin: [0, 20]},
      {
        columns: [
          {
            stack: [
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.6 - 15, y2: 5, lineWidth: 0.7 }]},
              {text: this.structure[type].mainTitle, style: ['blue', 'bold'], margin: [0, 10]},
              {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.6 - 15, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
              parseHTML(marked(category[this.structure[type].main]))
            ],
            width: '60%'
          },
          [
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7 }]},
            {text: this.structure[type].sideTitle.toUpperCase(), style: ['green', 'bold'], margin: [0, 10]},
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
            parseHTML(marked(category[this.structure[type].side])) // todo apply blue style
          ]
        ],
        pageBreak: 'after',
        footerMode: 'category'
      },
      {text: 'ACTION INDEX | ' + type.toUpperCase() + ": " + category.title.toUpperCase(), style: ['size10', 'grey', 'bold'], margin: [0, 20]},
      {text: relatedEntities.length + ' related Actions', style: ['size26', 'bold'], margin: [0, 20]},
      { columns: [
        {text: 'ID#', style: ['size6', 'grey'], width: '5%'},
        {text: 'GOVERNMENT ACTION', style: ['size6', 'grey'], width: '60%'},
        {text: 'SMART CRITERIA', style: ['size6', 'grey'], width: '25%'},
        {text: 'SECTION', style: ['size6', 'grey'], width: '5%'},
        {text: 'PAGE', style: ['size6', 'grey'], width: '5%'}
      ]},
      {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineWidth: 0.7 }]},
      { columns: [
        {text: '', style: 'size5_2', width: '65%'},
        {text: 'SPECIFIC', style: 'size5_2', width: '5%'},
        {text: 'MEASURABLE', style: 'size5_2', width: '5%'},
        {text: 'ASSIGNABLE', style: 'size5_2', width: '5%'},
        {text: 'RESULT\n-ORIENTED', style: 'size5_2', width: '5%'},
        {text: 'TIME\n-BOUND', style: 'size5_2', width: '5%'},
        {stack: [{text: 'Met', style: 'size5_2'}, {text: 'Not met', style: 'size5_2'}], width: '5%'},
        {stack: [{image: 'icon_smart_key_yes', width: 5}, {image: 'icon_smart_key_no', width: 5}], width: '5%'}
      ]},
      {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520, y2: 5, lineColor: '#9aa6a6', lineWidth: 0.7 }]},
  ...
  getAll: function (payload, relatedEntities, allAgencies, allGroups, allIssues) {
    ...
    var allContent = {
      content: [
        ...
        {text: "For the Protection and Promotion of Human Rights", style: ["white", "size12"]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.8, y2: 5, lineWidth: 0.7 }]},
        {text: 'FULL REPORT', style: ["white", "size10", "bold"]},
        {text: 'NATIONAL PLAN OF ACTION', style: ['size34', 'white'], margin: [0, 20]},
        {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7 }]},
        {text: 'IN THIS REPORT:', style: ["white", "size10", "bold"]},
        {text: 'Section A', style: ["white", "bold"]},
        {text: 'Analysis by Issue, Population Group and Government Agency', style: ["white"]},
        {text: 'Section B', style: ["white", "bold"]},
        {text: relatedEntitiesAction.length + ' Government Actions', style: ["white"]},
        {columns: [
          {stack: [
            {canvas: [{ type: 'line', x1: 0, y1: 5, x2: 520 * 0.4, y2: 5, lineWidth: 0.7, lineColor: '#ffffff'  }]},
            {text: [{text:'DATE ', style: ["white", "bold"]}, {text: moment().format('DD/MM/YYYY'), style: "white"}]},
